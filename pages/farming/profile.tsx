	...
	return (
		<>
			...
			{ !userTotals?.total_points || userTotals?.total_points == 0 ?
				<Main>
					<div style={{height: '100vh'}} className="px-8 sm:px-0 flex flex-col justify-center items-center bg-primary gap-6 text-black">
				...
				<Main>
					<div style={{minHeight: '100vh'}} className="px-8 sm:px-0 flex flex-col justify-center items-center bg-primary gap-6 text-black">
