const rooms = [
	{
		...
		description: 'Lock BNB or prove volume\\nEarn Voting Power',
		emoji: '⛲',
		token: 'BNB',
		exchange_id: 'Binance',
		needsApiPass: false,
	...
	},
	{
		...
		description: 'Lock KCS or prove volume\\nEarn Voting Power',
		emoji: '🛖',
		token: 'KCS',
		exchange_id: 'Kucoin',
		needsApiPass: true,
	...
	// {type:"cex", key: 4, name: "His Excellency’s Chambers", description: "Lock HT, Earn Voting Power", emoji: "🧖‍♂️", token: "HT", exchange_id: "Huobi", needsApiPass: false},
	{
		...
		description: 'Lock BMEX or prove trading volume\\nEarn Voting Power',
		emoji: '💃',
		token: 'BMEX',
		exchange_id: 'Bitmex',
		needsApiPass: false,
	...
	// },
	{
		...
		description: 'Lock GMX or prove trading volume\\nEarn Voting Power',
		emoji: '🫐',
		token: 'GMX',
	...
	},
	{
		...
		key: 9,
		name: 'OKX Pitstop',
		description: 'Lock OKB or prove volume\\nEarn Voting Power',
		emoji: '🏁',
		token: 'OKB',
		exchange_id: 'OKX',
		needsApiPass: true,
	...
	},
	{
		...
		description: 'Lock BGB or prove volume\\nEarn Voting Power',
		emoji: '🧺',
		token: 'BGB',
		exchange_id: 'Bitget',
		needsApiPass: true,
	...
	},
	{
		...
		key: 11,
		name: 'MEXC Nursery',
		description: 'Lock MX or prove volume\\nEarn Voting Power',
		emoji: '🤱',
		token: 'MX',
		exchange_id: 'MEXC',
		needsApiPass: false,
	...
	},
	{
		...
		description: 'Prove trading volume\\nEarn Voting Power',
		emoji: '🐙',
		token: '',
		exchange_id: 'Kraken',
